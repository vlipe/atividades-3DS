...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col justify-between">
    ...
    <header class="p-8">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="flex items-center space-x-1 font-medium text-sm">
                <a href="{{ route('home') }}" class="bg--[#B20000] text-white px-10 py-2.5 rounded-full transition">Início</a>
    ...
    <main class="container mx-auto px-6 py-12 flex-grow max-w-5xl">
        <div class="bg-white rounded-3xl p-8 shadow-xs border border-gray-100 flex flex-col md:flex-row items-center gap-8 mb-16">
            <div class="flex-1">
                <span class="text-red-700 text-xs">Vestibulinho 2026</span>
                <h2 class="text-4xl font-extrabold mt-2 mb-4 leading-tight text-gray-900">Futuro e Tecnologia se encontram na <span class="text-red-700">Zona Leste</span>.</h2>
                <p class="text-gray-500 mb-6">Venha estudar na instituição que é referência em ensino técnico gratuito em São Paulo. Infraestrutura moderna e professores atuantes no mercado.</p>
                <a href="{{ route('cursos') }}" class="inline-block bg-[#B20000] hover:bg-[#B20000] text-white px-6 py-3 rounded-3xl transition">
                    Conhecer Nossos Cursos
                </a>
            </div>
            <div class="w-full md:w-2/5 h-64">
    <img src="{{ asset('home.png') }}"
         alt="Destaque Etec Zona Leste"
         class="w-full h-full object-cover rounded-2xl shadow-xs border border-gray-100">
</div>
        </div>

        <div class="mb-16 max-w-xl">
            <h3 class="text-2xl font-bold text-gray-700 mb-6">Eventos Próximos</h3>
            <div class="flex items-center gap-6 mb-6">
                <div class="text-center min-w-[70px]">
                    <span class="block text-5xl font-bold text-[#B20000] leading-none">09</span>
                    <span class="block text-xl font-medium text-[#B20000] mt-1">mai.</span>
                </div>
                <div class="h-12 w-[2px] bg-gray-200"></div>
                <p class="text-lg font-medium text-gray-600">Dia da Escola Família</p>
            </div>
            <div class="flex items-center gap-6 mb-6">
                <div class="text-center min-w-[70px]">
                    <span class="block text-5xl font-bold text-[#B20000] leading-none">13</span>
                    <span class="block text-xl font-medium text-[#B20000] mt-1">mai.</span>
                </div>
                <div class="h-12 w-[2px] bg-gray-200"></div>
                <p class="text-lg font-medium text-gray-600">Semana Paulo Freire</p>
            </div>
            <div class="flex items-center gap-6 mb-6">
                <div class="text-center min-w-[70px]">
                    <span class="block text-5xl font-bold text-[#B20000] leading-none">20</span>
                    <span class="block text-xl font-medium text-[#B20000] mt-1">jun.</span>
                </div>
                <div class="h-12 w-[2px] bg-gray-200"></div>
                <p class="text-lg font-medium text-gray-600">Festa das Nações</p>
            </div>
        </div>
    </main>
