...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col justify-between">
    ...
    <header class="p-8">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="flex items-center space-x-1 font-medium text-sm">
                ...
                <a href="{{ route('eventos') }}" class="bg-[#B20000] text-white px-10 py-2.5 rounded-full transition">Eventos</a>
    ...
    <main class="container mx-auto px-6 py-12 flex-grow max-w-5xl">
        ...
        <div class="mb-12 text-center md:text-left">
            <h2 class="text-3xl font-extrabold text-gray-900">Agenda de <span class="text-[#B20000]">Eventos</span></h2>
            <p class="text-gray-500 mt-2">Fique por dentro das atividades acadêmicas, palestras e prazos institucionais da nossa unidade.</p>
        </div>

        <div class="bg-white rounded-3xl p-8 shadow-xs border border-gray-100 space-y-10 mb-16">
            ...
            <div class="flex items-center gap-6">
                ...
                <div>
                    <p class="text-lg font-semibold text-gray-800">Dia da Escola Família</p>
                    <p class="text-sm text-gray-400 mt-0.5">Horário: 09h às 16h • Evento aberto à comunidade local.</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="h-12 w-[2px] bg-gray-200"></div>
                <div>
                    <p class="text-lg font-semibold text-gray-800">Início das Inscrições para o Vestibulinho</p>
                    <p class="text-sm text-gray-400 mt-0.5">Prazo inicial para inscrições nos cursos técnicos do próximo semestre.</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-6">
                <div class="text-center min-w-[70px]">
                    <span class="block text-5xl font-bold text-[#B20000] leading-none">27</span>
                    <span class="block text-xl font-medium text-[#B20000] mt-1">nov.</span>
                </div>
                <div class="h-12 w-[2px] bg-gray-200"></div>
                <div>
                    <p class="text-lg font-semibold text-gray-800">Feira de Tecnologia e Trabalho (TCC)</p>
                    <p class="text-sm text-gray-400 mt-0.5">Apresentação dos projetos de conclusão de curso dos formandos de DS e Administração.</p>
                </div>
            </div>
